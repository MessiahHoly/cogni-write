...
export default function CommentItem({ comment, isAuthenticated }: { comment: CommentNode, isAuthenticated: boolean }) {
  ...
  return (
    <div className="space-y-4 border-b pb-6 last:border-0 last:pb-0 scroll-mt-20 transition-colors duration-500 target:bg-primary/10 target:p-3 target:rounded-lg"
      id={comment.id}>
      {/* Top Level Comment */}
